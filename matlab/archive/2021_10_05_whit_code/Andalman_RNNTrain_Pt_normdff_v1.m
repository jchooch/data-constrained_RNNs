function  Andalman_RNNTrain   
    simfilename = 'C:\Users\Whit\Documents\MATLAB\fr.mat'; %replace with input path
    outputname ='C:\Users\Whit\Documents\MATLAB\output_pt_norm_dff_125_epoch'; %replace with output path
    learn = 1; %lets RNN learn
    nRunTot = 125; %number of steps
    ...
    N = 321; % #neurons - however many rows or neuron time series you are training
    ...
    for nRun = 1:nRunTot %Number of epochs
        ...
        plot(t(1:10:end),R(idx,1:10:end));
        plot(tData(1:10:end),Adata(idx,1:10:end));
        title(nRun)
        set(gca,'Box','off','TickDir','out','FontSize',14);
        subplot(2,4,5);
        hold on;
