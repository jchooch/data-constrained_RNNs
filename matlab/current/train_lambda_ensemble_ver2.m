...
repetitions = 1; % number of networks trained per lambda
Js = {}; Rs = {}; chi2s = {}; pVarss = {};
...
for lambda = lambdas
    ...
    for repetition = 1:repetitions
        [J, R, N, T, varData, chi2, pVars] = dcRNN_train_L1_ver2(calact410Nstd, inputs, 100, lambda);
...
save('10_lambs_1_rep_L1_ver2.mat')